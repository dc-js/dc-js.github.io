...
(function (global, factory) {
...
})(this, (function (exports, d3Dispatch, d3TimeFormat, d3Format, d3Time, d3Array, d3Scale, d3Interpolate, d3Selection, d3Timer, d3ScaleChromatic, d3Axis, d3Zoom, d3Brush, d3Shape, d3Geo, d3Ease, d3Hierarchy) { 'use strict';
  ...
  ***************************************************************************** */
   ...
   * - {@link http://dc-js.github.com/dc.js/crime/index.html | Canadian City Crime Stats}
   */
  class BubbleOverlay extends BubbleMixin(ColorMixin(BaseMixin)) {
      /**
   ...
   * - {@link http://dc-js.github.com/dc.js/ | Nasdaq 100 Index}
   */
  class PieChart extends ColorMixin(BaseMixin) {
      /**
       * Create a Pie Chart
       *
       * TODO update example
   ...
   * - {@link http://dc-js.github.com/dc.js/ | Nasdaq 100 Index}
   */
  class RowChart extends ColorMixin(MarginMixin) {
      /**
       * Create a Row Chart.
       *
       * TODO update example
  ...
  exports.RangedTwoDimensionalFilter = RangedTwoDimensionalFilter;
  ...
  exports.TwoDimensionalFilter = TwoDimensionalFilter;
  exports.UnitWithPrecision = UnitWithPrecision;
  exports.UnitsInteger = UnitsInteger;
  exports.UnitsOrdinal = UnitsOrdinal;
  exports.add = add;
  exports.afterTransition = afterTransition;
  exports.allChildren = allChildren;
  exports.appendOrSelect = appendOrSelect;
  ...
  exports.pluck2 = pluck2;
  exports.printFilter = printFilter;
  exports.printFilters = printFilters;
  exports.printSingleValue = printSingleValue;
  exports.safeNumber = safeNumber;
  exports.sortBy = sortBy;
  exports.subtract = subtract;
  exports.toHierarchy = toHierarchy;
